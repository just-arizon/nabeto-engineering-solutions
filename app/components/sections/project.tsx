...
export function ProjectSection() {
  const featuredProjects = [
  {
    ...
    year: "2021",
    description:
      "Construction and installation of underground tank, 4 in No's, Piping and installation work, Procurement and installation of dispensing pump, Supply and installation of electrical materials, Commision of the facility, and Engineering design and implementatiion",
    image: "/mushin.png",
  ...
  },
  {
    ...
    year: "2023",
    description:
      "Full EPC delivery of a liquefied natural gas processing facility with capacity of 8 million tonnes per annum.",
    image: "/petrosafe.png",
