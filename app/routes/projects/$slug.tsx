...
const details: Record<string, Project> = {
  ...
  "lpg-retail-station-construction": {
  ...
  "bulk-tank-construction": {
    title: "Bulk Tank Construction",
    location: "Lagos, Nigeria",
    client: "Pinnacle Oil & Gas",
    value: "₦3.2B",
    scope: "Full EPC delivery of a liquefied natural gas processing facility with capacity of 68M cubic meters.",
    completed: "2022",
    images: ["/bulk-tank.png"],
    services: ["Engineering", "Procurement", "Construction", "Operations"],
    highlights: [
      "Detailed engineering design of the tank farm",
      "Procurement of steel plate and other structured materials",
      "Construction of civil tank bases",
  ...
  "civil-construction-works": {
    ...
    location: "Koko, Delta State, Nigeria",
    client: "Optimal Oil & Gas",
    value: "₦2B",
    scope: "Full EPC delivery of filing and construction works.",
    completed: "2011",
    images: ["/tank-construction.png"],
    services: ["Engineering", "Procurement", "Construction", "Operations"],
    highlights: [
      "6 months duration",
      "Advanced modular construction approach",
  ...
  "lpg-underground-tank-construction": {
    title: "LPG Underground Tank Construction",
    location: "Lagos, Nigeria",
    client: "Obat Petroleum & Gas Limited",
    value: "₦500M",
    scope: "Full EPC delivery of a liquefied natural gas processing facility ",
    completed: "2022",
    images: ["/underground-tank.png"],
    services: ["Engineering", "Procurement", "Construction", "Operations"],
    highlights: [
      "8 MTPA processing capacity",
      "Advanced modular construction approach",
  ...
  "tank-base-construction": {
    ...
    location: "Lagos, Nigeria",
    client: "Fradro International",
    value: "₦3.5B",
    scope: "Full EPC delivery of a liquefied natural gas processing facility with capacity of 35M litres.",
    completed: "2013",
    images: ["/base-construction.png"],
    services: ["Engineering", "Procurement", "Construction", "Operations"],
    highlights: [
      "8 MTPA processing capacity",
      "Advanced modular construction approach",
